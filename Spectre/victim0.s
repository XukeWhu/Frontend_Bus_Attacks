...
array1:
	...
	.align 8
.LC0:
	.string	"The Msadasare Squeamish Ossifrage."
...
.L43:
	...
	cltq
	leaq	0(,%rax,4), %rdx
	leaq	results.27657(%rip), %rax
	movl	$0, (%rdx,%rax)
	addl	$1, -8000076(%rbp)
.L42:
	cmpl	$255, -8000076(%rbp)
	jle	.L43
	movl	$40000, -8000080(%rbp)
	jmp	.L44
.L49:
	movq	-8000032(%rbp), %rax
	addq	$25000, %rax
	movq	%rax, -8000032(%rbp)
	movl	-8000080(%rbp), %eax
